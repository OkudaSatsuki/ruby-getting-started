        ...
        when Line::Bot::Event::Message #ユーザーからメッセージが送られたとき
            ...
            when Line::Bot::Event::MessageType::Text
               str = event.message["text"]
                ...
                when "和音の種類を教えて"
                    message = [
                        {type: "text",text:"[長三和音(メジャーコード)]：長音階の1度、3度、5度からなる三和音です。明るい印象を与える和音です。表記はC、D、E..."},
                        {type: "text",text:"[短三和音(マイナーコード)]：短音階の1度、3度、5度からなる三和音です。長三和音の3度が半音低くなっている和音とも言えます。暗い印象を和音です。表記はCm、Dm、Em..."},
                        {type: "text",text:"[増三和音(オーギュメントコード)]:長三和音の5度が半音高くなっている和音です。表記はCaug、Daug、Eaug..."},
                        {type: "text",text:"[減三和音(ディミニッシュコード)]:短三和音の5度が半音低くなっている和音です。表記はCdim、Ddim、Edim..."},
                    ]
               #入力されたコードネームの構成音を探す
                else
                    @data.each do |code|
