...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { fifth: @datum.fifth, first: @datum.first, name: @datum.name, third: @datum.third } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { fifth: @datum.fifth, first: @datum.first, name: @datum.name, third: @datum.third } }
